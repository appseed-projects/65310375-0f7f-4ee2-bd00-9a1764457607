...
- Timestamp: `2022-06-10 17:31`
- Build ID: `65310375-0f7f-4ee2-bd00-9a1764457607`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/65310375-0f7f-4ee2-bd00-9a1764457607.git
$ cd 65310375-0f7f-4ee2-bd00-9a1764457607
```
